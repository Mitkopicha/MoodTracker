...
export default function SignUpPage() {
  ...
  async function submit(e) {
    ...
    try {
      ...
      const displayName = [first.trim(), last.trim()].filter(Boolean).join(" ").trim();
      if (displayName) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 min-h-[100svh] flex items-start md:items-center justify-center">
        ...
        >
          <h1 className="text-2xl font-semibold text-amber-900 tracking-tight text-center">Create Your MoodTrack Account</h1>
          ...
          <div className="grid grid-cols-2 gap-3 mt-5">
            <input
              ...
              className="col-span-1 w-full h-12 rounded-xl bg-white/90 border border-amber-200 px-3 text-[15px]
          ...
          <p className="text-sm text-center text-amber-900/90 mt-4">
            ...
            <a className="font-medium underline underline-offset-2" href="/auth/sign-in">
              Log in
            </a>
          </p>
        </form>
